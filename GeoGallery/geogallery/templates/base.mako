...
<html lang="en" metal:define-macro="layout">
  <head>
    ...
    <link rel="stylesheet" href="${request.static_url('deform:static/css/ui-lightness/jquery-ui-1.8.11.custom.css')}" type="text/css" media="screen" charset="utf-8" />
  	<link rel="stylesheet" href="${request.static_url('geogallery:static/css/flexvmail.css')}" type="text/css" media="screen" charset="utf-8" />
  </head>
  ...
  <body>
      ...
      <div class="navbar-inner">
        <div class="container-fluid">
	      ...
	      <a class="brand" href="${request.application_url}">Geo-Gallery</a>
	      %if request.user:
